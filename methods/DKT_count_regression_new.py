...
class DKT_count_regression_new(nn.Module):
    def __init__(self, backbone, base_file=None, val_file=None,
        video_path=None, show_plots_loss=False, show_plots_pred=False, show_plots_features=False, training=False):
        super(DKT_count_regression_new, self).__init__()
        ## GP parameters
...
class ExactGPLayer(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood, kernel='linear'):
        ...
        if(kernel=='rbf' or kernel=='RBF'):
            ...
            self.covar_module = gpytorch.kernels.AdditiveKernel(base_kernel, base_kernel)
        ## Spectral kernel
